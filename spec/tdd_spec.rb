...
RSpec.describe Alimento do
    before :each do
        @alimento1 = Alimento.new("Huevo frito",14.1,0.0,19.5,nil)
        @alimento2 = Alimento.new("Leche vaca",3.3,4.8,3.2,nil)
        @alimento3 = Alimento.new("Yogurt",3.8,4.9,3.8,nil)
    end 
...
RSpec.describe Grupo_de_Alimento do
    context "1) Herencia" do
        before :each do
          @grupo1 = Grupo_de_Alimento.new('Alimentos grasos', 'Chocolate',5.3, 47.0, 30.0,nil)
        end    
    ...
    context "3) Listas de ALimentos por Grupo" do 
        before :all do 
          ...
          @grupo11 = Grupo_de_Alimento.new('Huevos, lácteos y helados', 'Huevo frito', 14.1, 0.0, 19.5,nil)
          @grupo12 = Grupo_de_Alimento.new('Huevos, lácteos y helados', 'Leche vaca', 3.3, 4.8, 3.2,nil)
          @grupo13 = Grupo_de_Alimento.new('Huevos, lácteos y helados', 'Yogurt', 3.8, 4.9, 3.8,nil)
          #Carnes y derivados
          @grupo21 = Grupo_de_Alimento.new('Carnes y derivados', 'Cerdo', 21.5, 0.0, 6.3,nil)
          @grupo22 = Grupo_de_Alimento.new('Carnes y derivados', 'Ternera', 21.1, 0.0, 3.1,nil)
          @grupo23 = Grupo_de_Alimento.new('Carnes y derivados', 'Pollo', 20.6, 0.0, 5.6,nil)
          #Pescados y mariscos
          @grupo31 = Grupo_de_Alimento.new('Pescados y mariscos', 'Bacalao', 17.7, 0.0, 0.4,nil)
          @grupo32 = Grupo_de_Alimento.new('Pescados y mariscos', 'Atún', 21.5, 0.0, 15.5,nil)
          @grupo33 = Grupo_de_Alimento.new('Pescados y mariscos', 'Salmón', 19.9, 0.0, 13.6,nil)
          #Alimentos grasos
          @grupo41 = Grupo_de_Alimento.new('Alimentos grasos', 'Aceite de oliva', 0.0, 0.2, 99.6,nil)
          @grupo42 = Grupo_de_Alimento.new('Alimentos grasos', 'Mantequilla', 0.7, 0.0, 83.2,nil)
          @grupo43 = Grupo_de_Alimento.new('Alimentos grasos', 'Chocolate', 5.3, 47.0, 30.0,nil)
          #Alimentos ricos en carbohidratos
          @grupo51 = Grupo_de_Alimento.new('Alimentos ricos en carbohidratos', 'Azúcar', 0.0, 99.8, 0.0,nil)
          @grupo52 = Grupo_de_Alimento.new('Alimentos ricos en carbohidratos', 'Arroz', 6.8, 77.7, 0.6,nil)
          @grupo53 = Grupo_de_Alimento.new('Alimentos ricos en carbohidratos', 'Lentejas', 23.5, 52.0, 1.4,nil)
          @grupo54 = Grupo_de_Alimento.new('Alimentos ricos en carbohidratos', 'Papas', 2.0, 15.4, 0.1,nil)
          #Verduras y Hortalizas
          @grupo61 = Grupo_de_Alimento.new('Verduras y Hortalizas', 'Tomate', 1.0, 3.5, 0.2,nil)
          @grupo62 = Grupo_de_Alimento.new('Verduras y Hortalizas', 'Cebolla', 1.3, 5.8, 0.3,nil)
          @grupo63 = Grupo_de_Alimento.new('Verduras y Hortalizas', 'Calabaza', 1.1, 4.8, 0.1,nil)
          #Frutas
          @grupo71 = Grupo_de_Alimento.new('Frutas', 'Manzana', 0.3, 12.4, 0.4,nil)
          @grupo72 = Grupo_de_Alimento.new('Frutas', 'Plátanos', 1.2, 21.4, 0.2,nil)
          @grupo73 = Grupo_de_Alimento.new('Frutas', 'Pera', 0.5, 12.7, 0.3,nil)
...
RSpec.describe Comparable do
    before :all do 
      @alimento1 = Alimento.new('Cerdo', 21.5, 0.0, 6.3,nil)
      @alimento2 = Alimento.new('Plátanos', 1.2, 21.4, 0.2,nil)
      
      @grupo_alimento1 = Grupo_de_Alimento.new('Huevos, lácteos y helados', 'Huevo frito', 14.1, 0.0, 19.5,nil)
      @grupo_alimento2 = Grupo_de_Alimento.new('Frutas', 'Manzana', 0.3, 12.4, 0.4,nil)
      @grupo_alimento3 = Grupo_de_Alimento.new('Frutas', 'Pera', 0.5, 12.7, 0.3,nil)
    end
    ...
    #      expect(@grupo_alimento1 ).to be_between(@grupo_alimento1,@grupo_alimento3)
    #   end
    end 
end
...
RSpec.describe Alimento do   
    ...
    @compota_manzana = Alimento.new("Compota de Manzana",0.2, 15.0,0.1,[[6.7,6.5,6.8,6.9,7.0,7.1,6.9,6.9,6.9,6.7,6.9,7.3,7.0,7.0,7.2,7.1,6.8,7.2,7.3,7.0,6.8,6.7,6.8,6.7,6.9],
...
RSpec.describe Grupo_de_Alimento do 
    before :each do  
          @lista = Lista.new()
          #Huevos lácteos y helados 
          @grupo11 = Alimento.new('Huevo frito', 14.1, 0.0, 19.5,nil)
          @grupo12 = Alimento.new('Leche vaca', 3.3, 4.8, 3.2,nil)
          @grupo13 = Alimento.new('Yogurt', 3.8, 4.9, 3.8,nil)
          #Carnes y derivados
          @grupo21 = Alimento.new('Cerdo', 21.5, 0.0, 6.3,nil)
          @grupo22 = Alimento.new('Ternera', 21.1, 0.0, 3.1,nil)
          @grupo23 = Alimento.new('Pollo', 20.6, 0.0, 5.6,nil)
          #Pescados y mariscos
          @grupo31 = Alimento.new('Bacalao', 17.7, 0.0, 0.4,nil)
          @grupo32 = Alimento.new('Atún', 21.5, 0.0, 15.5,nil)
          @grupo33 = Alimento.new('Salmón', 19.9, 0.0, 13.6,nil)
          #Alimentos grasos
          @grupo41 = Alimento.new('Aceite de oliva', 0.0, 0.2, 99.6,nil)
          @grupo42 = Alimento.new('Mantequilla', 0.7, 0.0, 83.2,nil)
          @grupo43 = Alimento.new('Chocolate', 5.3, 47.0, 30.0,nil)
          #Alimentos ricos en carbohidratos
          @grupo51 = Alimento.new('Azúcar', 0.0, 99.8, 0.0,nil)
          @grupo52 = Alimento.new('Arroz', 6.8, 77.7, 0.6,nil)
          @grupo53 = Alimento.new('Lentejas', 23.5, 52.0, 1.4,nil)
          @grupo54 = Alimento.new('Papas', 2.0, 15.4, 0.1,nil)
          #Verduras y Hortalizas
          @grupo61 = Alimento.new('Tomate', 1.0, 3.5, 0.2,nil)
          @grupo62 = Alimento.new('Cebolla', 1.3, 5.8, 0.3,nil)
          @grupo63 = Alimento.new('Calabaza', 1.1, 4.8, 0.1,nil)
          #Frutas
          @grupo71 = Alimento.new('Manzana', 0.3, 12.4, 0.4,nil)
          @grupo72 = Alimento.new('Plátanos', 1.2, 21.4, 0.2,nil)
